...
import { lerpPoints } from "@/lib/clip-path";
...
export default function LogoRevealSVG({ play }: { play: boolean }) {
  ...
  const clipId = `clip0-${uid}`;
  const birseId = `birseWipe-${uid}`;
  const thomasId = `thomasWipe-${uid}`;
